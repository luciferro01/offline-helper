  ...
  actions: {
    ...
    async addToCart(productOfferingId, quantity) {
      ...
      try {
        ...
        console.log("offeringg"+productOfferingId)
        await api.post(
          `/carts/addToCart?productOfferingId=${productOfferingId}&quantity=${quantity}`,
        )
...
//     // Method to set the current page for pagination
//     setPage(page) {
