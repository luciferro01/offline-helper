package com.mohil_bansal.sellerservice.seller_service.config;
...
public class KafkaProducerConfig {
    ...
    public ProducerFactory<String, ProductOfferingUpdateEvent> producerFactory() {
        ...
        configProps.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, JsonSerializer.class); // Serialize event as JSON
